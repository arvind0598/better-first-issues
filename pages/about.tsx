...
const About: NextPage = () => {
  ...
  const AboutParagraph: FC<{}> = ({ children }) => {
      ...
      <Box align="center" justify="center" direction="column" pad="large">
        ...
        <Box align="center" justify="center" direction={flexDirection} pad={boxPadding}>
          <Grid fill columns={columnsLayout[size]} gap="small">
            ...
            <Box>
              <AboutParagraph>
                Better First Issues targets developers who want to contribute to open-source software but do not know where or how to start. Github does provide its own advanced search, but I have always found it too convoluted to use.
              </AboutParagraph>
              <AboutParagraph>
                By providing developers with filters, this website empowers them to browse and select issues and repositories based on programming languages that they are comfortable with. In addition, they can choose the type of issues they want to address.
              </AboutParagraph>
              <AboutParagraph>
                This project is inspired by <Anchor label="Good First Issues" href="http://goodfirstissues.com/" />, a similar project by Daren Sin.
              </AboutParagraph>
            </Box>
          </Grid>
        </Box >
